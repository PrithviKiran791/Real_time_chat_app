...
export function Button({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative flex h-full w-full items-center justify-center border border-slate-800 bg-slate-900/90 md:bg-slate-900/[0.8] text-sm text-white antialiased md:backdrop-blur-xl",
          className
        )}
        style={{
