          ...
          <div>
            <Link href="#home" className="flex items-center gap-2">
              <span className="flex size-8 items-center justify-center rounded-xl bg-white/10">
                <MessageCircle className="size-[18px] text-[#60A5FA]" />
              </span>
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex size-9 items-center justify-center rounded-lg bg-white/10 text-[#93C5FD] transition-colors hover:bg-[#1E3A8A] hover:text-white"
              >
